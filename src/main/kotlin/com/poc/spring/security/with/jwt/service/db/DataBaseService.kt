    ...
    fun instantiateTestDataBase() {
        ...
        val usu1 = User(
            ...
            email = "leo.siqueira@gmail.com", birthDate = "10/10/1990", loggedByFace = true, photo = "${UUID
                .randomUUID()}", profiles = hashSetOf("ROLE_CLIENT")
        )
        val usu2 = User(
            name = "Tester", cpfOrCnpj = "1010101034", userName = "tester@hotmail.com", passwords = "123",
            email = "tester@hotmail.com", birthDate = "10/10/1980", profiles = hashSetOf("ROLE_CLIENT")
        )
        val usu3 = User(
            name = "Victor Gomes", cpfOrCnpj = "1010101034", userName = "vict", passwords = "123",
            email = "vito.gomes@gmail.com", birthDate = "10/10/2000", profiles = hashSetOf("ROLE_ADMIN")
        )
        val usu4 = User(
            ...
            profiles = hashSetOf("ROLE_CLIENT")
        )
        val usu5 = User(
            name = "Zezin da Silva", cpfOrCnpj = "102030009", userName = "zezin.silva@gmail.com", passwords = "123",
            email = "zezin.silva@gmail.com", birthDate = "10/10/1960", profiles =hashSetOf("ROLE_CLIENT")
        )
